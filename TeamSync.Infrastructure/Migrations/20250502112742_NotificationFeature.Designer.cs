...
namespace TeamSync.Infrastructure.Migrations
{
    ...
    [Migration("20250502112742_NotificationFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.ChatEntities.ChatNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.ProjectEntities.ProjectRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("793d7f3b-fa08-40fd-ba1f-41adec179ecc"),
                            ProjectRoleName = "Administrator"
                        },
                        new
                        {
                            Id = new Guid("00ebde90-6f75-45c7-b78e-89f3ed485bff"),
            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.TaskEntities.TaskStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("826cb250-43e8-455d-ae77-e3d82c6b55bc"),
                            StatusName = "Pending"
                        },
                        new
                        {
                            Id = new Guid("860e9698-2a1a-44c2-be81-3ddd54dd03c5"),
                            StatusName = "InWork"
                        },
                        new
                        {
                            Id = new Guid("3c90a6c1-af5b-4c29-b84b-44e25a25f8b2"),
                            StatusName = "Done"
                        },
                        new
                        {
                            Id = new Guid("427e94e2-499d-4909-8f3c-ecc7b56c4602"),
                            StatusName = "Closed"
                        });
                });
