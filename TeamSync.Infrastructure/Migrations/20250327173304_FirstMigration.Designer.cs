...
namespace TeamSync.Infrastructure.Migrations
{
    ...
    [Migration("20250327173304_FirstMigration")]
            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.ProjectEntities.ProjectRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4297b324-059e-4ae6-a99d-7ebee3e5b731"),
                            ProjectRoleName = "Administrator"
                        },
                        new
                        {
                            Id = new Guid("c4ada97f-cefb-4dc6-9e5c-f1a9040f701f"),
            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.TaskEntities.TaskStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("08cb7114-b9a2-4ad1-83de-eabdbab2ee79"),
                            StatusName = "Pending"
                        },
                        new
                        {
                            Id = new Guid("50ac0d58-2258-4661-b908-8d26ff9ab1f2"),
                            StatusName = "InWork"
                        },
                        new
                        {
                            Id = new Guid("444673d3-4b78-40c4-b2ac-8173b2128434"),
                            StatusName = "Done"
                        },
                        new
                        {
                            Id = new Guid("b4a299cc-677c-4ad5-a39b-d8cd1470066f"),
                            StatusName = "Closed"
                        });
                });
