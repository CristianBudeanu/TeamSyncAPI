            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.ProjectEntities.ProjectRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e4fa2d4d-6500-4d4f-b75f-84be3b6293f5"),
                            ProjectRoleName = "Administrator"
                        },
                        new
                        {
                            Id = new Guid("c40ecf32-7fcb-4049-aca9-848d6642e17b"),
            ...
            modelBuilder.Entity("TeamSync.Domain.Entities.TaskEntities.TaskStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("73712a4d-96dd-47b0-a2cc-8b39601a6eae"),
                            StatusName = "Pending"
                        },
                        new
                        {
                            Id = new Guid("a2bb74b9-0a0d-44ac-94b8-b4b3763dccfc"),
                            StatusName = "InWork"
                        },
                        new
                        {
                            Id = new Guid("8e749c8b-e52a-4edb-bfae-f6675055243b"),
                            StatusName = "Done"
                        },
                        new
                        {
                            Id = new Guid("2f7de79c-1300-468e-8f5d-0b3e90c2d7d4"),
                            StatusName = "Closed"
                        });
                });
